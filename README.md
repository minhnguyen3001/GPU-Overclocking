...
1. [Prerequisites and Stability Tests](#prerequisites-and-stability-tests)
   ...
   4. [Benchmarks](#benchmarks)
      ...
      2. [Avoid](#avoid)
2. [GPU & Overclocking Info](#overclocking-info)
   1. [What is GPU stands for?] 
   2. [What is Overclocking and Undervolting?](#what-is-overclocking-and-undervolting)
   3. [Benefits of Overclocking and Undervolting](#benefits-of-overclocking-and-undervolting)
   4. [Overclocking vs. Undervolting](#overclocking-vs-undervolting)
   5. [Definitions of HWiNFO Performance Limits](#definitions-of-hwinfo-performance-limits)
   6. [Misconceptions](#misconceptions)
